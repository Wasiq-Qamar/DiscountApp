...
import { DataTable, TextInput, Text } from 'react-native-paper';
...
const HomeScreen = ({route, navigation}) => {
  ...
  useEffect(() => {
    ...
    if (price!=="" && discount!=="" && eval(discount)<100 && buttonState===true)
      setButtonState(false);
    else if (price==="" && discount==="" && eval(discount)>=100 && buttonState===false)
      setButtonState(true);
    else{}
  ...
  return(
    <LinearGradient colors={['#363795', '#005c97']}
    ...
    <LinearGradient colors={['#363795', '#005c97']}
      ...
      <DataTable >
        <DataTable.Header >
          ...
          <DataTable.Title numeric theme={theme}> Final Price </DataTable.Title>
          <DataTable.Title style={{justifyContent:'flex-end'}} theme={theme}> Remove </DataTable.Title>
        </DataTable.Header>
